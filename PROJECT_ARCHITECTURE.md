...
- [GPU_SIMULATION.md](GPU_SIMULATION.md) — **EXPERIMENTAL.** The GPU simulation feasibility PoC (Phase 2A SAND, Phase 2B WATER, Phase 2C real-time timestep integration — SIMULATION_TIMESCALE.md) and the renderer migration (§2 below) it required. The CPU simulation described throughout this document remains PRODUCTION/REFERENCE, completely unmodified by it.
